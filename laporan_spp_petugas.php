...
include'session.php';
  ...
  ?>
    ...
    <div class="content-wrapper">
      ...
      <div class="col-md-6">
            <!-- Horizontal Form -->
            <form action="result_laporan_spp_petugas.php" method="post">
            ...
            <tr><th>
                ...
                <a href="cetak_laporan_petugas.php" name="cetak" value="Cetak" data-toggle="modal" data-target="#exampleModal" style="margin-left:10px;margin-top:10px;" class="btn btn-success">Cetak</a>
            </th>
  <th>
