  ...
  // }
    ?>
      <div class="modal-header">
          <h3 class="modal-title" id="exampleModalLabel" style="text-align:center;">Export DATA</h3>
          <button type="button" class="close" data-dismiss="modal" onclick="javascript:window.location.reload()" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
    <form action="export_proses_petugas.php" method="post">
                      <table>
              <tr><th>
            ...
            <tr><th>
                <input type="submit" name="export" value="Export" style="margin-left:10px;margin-top:10px;" class="btn btn-primary">
            </th>
  <th>
