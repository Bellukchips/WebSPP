  ...
  ?>
    ...
    <div class="content-wrapper">
      ...
      <div class="col-md-6">
            ...
            <div class="box box-secondary" style="border-radius:10px;width:1100px;box-shadow:1px 2px 10px 2px red;">
              <div class="box-header with-border">
                <h3 class="box-title">Selamat Datang Petugas! <?php echo  $_SESSION['petugas']; ?></h3>
              </div>
              <!-- /.box-header -->
              <!-- form start -->
                ...
                <div class="box-body">
                  <div class="form-group">
                    <div class="col-sm-10">
                      ...
                      <a href="https://drive.google.com/open?id=1FObdiwuABqxWsoG1oVZVmfAiMSr_T7un">Klik Disini</a> <label>Untuk Mengetahui Tata Cara Penggunaan Aplikasi Ini, Namun Membutuhkan Koneksi Internet</label>
                        </div>
                  </div>
                  <div class="form-group">
