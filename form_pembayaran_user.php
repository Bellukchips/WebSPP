...
include'session.php';
  ...
  echo '<label style="margin-left:30px;">'.$d['nama'].'</label><br/>';
    ...
    echo '</td>';
      echo '<td>';
    echo '<label style="margin-left:40px">Cetak</label';
    echo '</td>';
    echo '<td>';
    echo ":";
    echo '</td>';
    echo '<td>';
          echo '<a href="cetak_user.php?nis='.$d['nis'].'" class="btn btn-primary"> <span class="glyphicon glyphicon-print"></span> Cetak</a><br/>';
    echo '</td>';
    echo '</tr>';
    echo '</table>';
  }
  ...
  echo '<td>'.$c['kelas'].'</td>';
  echo '<td><a href="aksi_bayar.php?nis='.$c['nis'].'&&id_bulan='.$c['id_bulan'].'" class="btn btn-success"  data-toggle="modal" data-target="#exampleModal"><span class="glyphicon glyphicon-check"></span</a></td>';
  echo '</tr>';
  }
