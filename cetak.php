  ...
  <body>
      ...
      <!--bagian isi-->
          <a onclick="location.href='menu_utama.php'" class="btn btn-danger" id="kembali">Kembali</a>
  ...
  $q=mysqli_query($koneksi,"SELECT SUM(set_nominal) FROM t_kelas inner join imports on imports.id_kelass=t_kelas.id_kelas inner join t_bulan where nis='$niss' and id_bulan NOT IN(SELECT id_bulann from spp where id_siswa='$nis')") or die(mysqli_error());
